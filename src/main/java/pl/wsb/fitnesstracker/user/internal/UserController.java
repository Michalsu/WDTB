...
class UserController {
    ...
    //http://localhost:8081/v1/users/basic
    @GetMapping("/basic")
    ...
    //http://localhost:8081/v1/users/byName?firstName=Emma&lastName=Johnson
    //http://localhost:8081/v1/users/byName?firstName=Ethan&lastName=Taylor
    @GetMapping("/byName")
